 ...
 */
export function buildOnStreamComplete({ provider, model, connectionId, apiKey, requestStartTime, body, stream, finalBody, translatedBody, clientRawRequest, pxpipe, reqTag, log, onQuotaSettled }) {
  ...
  const onStreamComplete = (contentObj, usage, ttftAt) => {
    ...
    if (onQuotaSettled) Promise.resolve().then(() => onQuotaSettled(usage)).catch((error) => console.error("[Quota] Stream settlement failed:", error.message));
